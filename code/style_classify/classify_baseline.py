...
from models import BiLSTMForSequenceClassification
...
class BiLSTMConfig():
    def __init__(self,
                 ...
                 **kwargs):
        super(BiLSTMConfig, self).__init__(**kwargs)
    ...
    for eval_task, eval_output_dir in zip(eval_task_names, eval_outputs_dirs):
        ...
        if preds is not None:
            ...
            with open(output_pred_file, "w") as writer:
                ...
                for idx, (pred_id, pred) in enumerate(zip(preds_ids,preds)):
                    writer.write("{}\t".format(pred_id))
                    writer.write("{}\n".format(
...
def main():
    ...
    #.from_pretrained(args.config_name if args.config_name else args.model_name_or_path, num_labels=num_labels, finetuning_task=args.task_name)
